...
# make new data frame
raw_renin_22_23 <- select(Nov22_Nov23_minimal_dataset, c("Centre.ID.x", "Sex.at.birth.x", "Renin.plasma.activity" ))

# change Centre ID to factor variable (to be able to use it as x axis)
raw_renin_22_23$Centre.ID.x <- as.factor(raw_renin_22_23$Centre.ID.x)

# remove rows with NA for height
raw_renin_22_23 <- raw_renin_22_23 [!is.na(raw_renin_22_23$Renin.plasma.activity),]

# basic box plot
graph_renin_22_23 <- ggplot(data = raw_renin_22_23, aes(x = Centre.ID.x, y = Renin.plasma.activity, fill = Sex.at.birth.x)) +
  geom_boxplot() +
...
# basic box plot, split by sex
graph_renin_22_23_sex_split <- ggplot(data = raw_renin_22_23, aes(x = Centre.ID.x, y = Renin.plasma.activity, fill = Sex.at.birth.x)) +
  geom_boxplot() +
...
# make new data frame
raw_renin_23_25 <- select(Nov23_Feb25_minimal_dataset, c("Centre.ID.x", "Sex.at.birth.x", "Renin.plasma.activity" ))

# change Centre ID to factor variable (to be able to use it as x axis)
raw_renin_23_25$Centre.ID.x <- as.factor(raw_renin_23_25$Centre.ID.x)

# remove rows with NA for height
raw_renin_23_25 <- raw_renin_23_25 [!is.na(raw_renin_23_25$Renin.plasma.activity),]

# basic box plot
graph_renin_23_25 <- ggplot(data = raw_renin_23_25, aes(x = Centre.ID.x, y = Renin.plasma.activity, fill = Sex.at.birth.x)) +
  geom_boxplot() +
...
# basic box plot, split by sex
graph_renin_23_25_sex_split <- ggplot(data = raw_renin_23_25, aes(x = Centre.ID.x, y = Renin.plasma.activity, fill = Sex.at.birth.x)) +
  geom_boxplot() +
