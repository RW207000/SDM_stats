...
graph_renin_22_23_sex_split <- ggplot(data = raw_renin_22_23, aes(x = Centre.ID.x, y = Renin.value, fill = Sex.at.birth.x)) +
  geom_boxplot() +
  labs(title = "Renin plasma activity distribution 22-23 (split by sex)", x = "Centre ID", y = "Renin plasma activity value (uIU/ml)") +
  theme_minimal() +
  scale_fill_manual(values = myColours) +
  facet_wrap(~ Sex.at.birth.x)
...
graph_renin_23_25_sex_split <- ggplot(data = raw_renin_23_25, aes(x = Centre.ID.x, y = Renin.value, fill = Sex.at.birth.x)) +
  geom_boxplot() +
  labs(title = "Renin plasma activity distribution 23-25 (split by sex)", x = "Centre ID", y = "Renin plasma activity value (uIU/ml)") +
  theme_minimal() +
  scale_fill_manual(values = myColours) +
  facet_wrap(~ Sex.at.birth.x)
