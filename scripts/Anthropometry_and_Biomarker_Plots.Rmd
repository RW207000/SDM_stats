...
BMI_22_23 <- MDBoxPlot(Nov22_Nov23_minimal_dataset, "BMI", "None", "BMI 22-23 (overall)")
...
testosterone_23_25 <- MDBoxPlot(Nov23_Feb25_minimal_dataset, "Total.testosterone.value", "NTEO", "Testosterone 23-25")

renin_22_23 <- MDBoxPlot(Nov22_Nov23_minimal_dataset, "Renin.plasma.activity", "NTEO", "Renin plasma activiy 22-23")

renin_23_25 <- MDBoxPlot(Nov23_Feb25_minimal_dataset, "Renin.plasma.activity", "NTEO", "Renin plasma activiy 23-25")

OHP_22_23 <- MDBoxPlot(Nov22_Nov23_minimal_dataset, "X17.OHP.value", "SBS", "17 OHP values 22-23")

OHP_23_25 <- MDBoxPlot(Nov23_Feb25_minimal_dataset, "X17.OHP.value", "SBS", "17 OHP values 23-25")

Andro_22_23 <- MDBoxPlot(Nov22_Nov23_minimal_dataset, "Androstenedione.value", "NTEO", "Andro values 22-23")

Andro_23_25 <- MDBoxPlot(Nov23_Feb25_minimal_dataset, "Androstenedione.value", "NTEO", "Andro values 23_25")
```
