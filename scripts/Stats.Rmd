...
therapy <- select(Nov23_Feb25_minimal_dataset, c("Centre.ID.x", "CO.ID.x", "Medicine_1.x", "Medicine_2.x", "Medicine_3.x", "Medicine_4.x"))

therapy$"single/combined" <- NA

# therapy$`single/combined` <-
#   ifelse(therapy$Medicine_1.x == therapy$Medicine_2.x &
#          therapy$Medicine_2.x == therapy$Medicine_3.x &
#           therapy$Medicine_3.x == therapy$Medicine_4.x,
#           as.character("single"),
#           as.character("combined"))

# check for single
therapy$single <-
  ifelse(!is.na(therapy$Medicine_1.x) &
         (is.na(therapy$Medicine_2.x) & is.na(therapy$Medicine_3.x) & is.na(therapy$Medicine_4.x) |
          therapy$Medicine_1.x == therapy$Medicine_2.x & is.na(therapy$Medicine_3.x) & is.na(therapy$Medicine_4.x) |
          therapy$Medicine_1.x == therapy$Medicine_2.x & therapy$Medicine_1.x == therapy$Medicine_3.x & is.na(therapy$Medicine_4.x) |
          therapy$Medicine_1.x == therapy$Medicine_2.x & therapy$Medicine_1.x == therapy$Medicine_3.x & therapy$Medicine_1.x == therapy$Medicine_4.x),
          TRUE, FALSE)
...
# need to work out how to ignore NA cells because ^ counts them as a value...
```
