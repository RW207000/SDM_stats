...
stat_frame_Nov22_Nov23 <- data.frame(cbind(names(stats_Nov22_Nov23_dose_per_BSA), t(stats_Nov22_Nov23_dose_per_BSA)))
stat_frame_Nov22_Nov23 <- select(stat_frame_Nov22_Nov23, -X1)
colnames(stat_frame_Nov22_Nov23) <- c("total_standardised_daily_dose_per_BSA (mg)")
```
...
colnames(stat_frame_Nov22_Nov23_kg) <- c("total_standardised_daily_dose_per_kg (mg)")


# join per kg to main stat frame
stat_frame_Nov22_Nov23$total_standardised_daily_dose_per_kg <- stat_frame_Nov22_Nov23_kg$`total_standardised_daily_dose_per_kg (mg)`
```
...
## change shape of data frame
stat_frame_Nov22_Nov23_height <- data.frame(cbind(names(stats_Nov22_Nov23_height), t(stats_Nov22_Nov23_height)))
stat_frame_Nov22_Nov23_height <- select(stat_frame_Nov22_Nov23_height, -X1)
colnames(stat_frame_Nov22_Nov23_height) <- c("Height (cm)")


# join height to main stat frame
stat_frame_Nov22_Nov23$"Height (cm)" <- stat_frame_Nov22_Nov23_height$"Height (cm)"
```
...
stats_Nov23_Feb25_dose_per_BSA <- Nov23_Feb25_minimal_dataset %>%
  summarise("mean" = mean(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "median" = median(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "SD" = sd(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "min" = min(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "max" = max(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "n" = length(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA[!is.na(Nov23_Feb25_minimal_dataset$total_standardised_daily_dose_per_BSA)])) %>%
  mutate_if(is.numeric, ~round(., 1))


##

stat_frame2 <- data.frame(cbind(names(stats_Nov23_Feb25_dose_per_BSA), t(stats_Nov23_Feb25_dose_per_BSA)))
stat_frame2 <- select(stat_frame2, -X1)
colnames(stat_frame2) <- c("Nov23-Nov25 total_standardised_daily_dose_per_BSA")

##
stat_frame$"Nov23-Nov25 total_standardised_daily_dose_per_BSA" <- stat_frame2$`Nov23-Nov25 total_standardised_daily_dose_per_BSA`
