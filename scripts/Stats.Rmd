...
# I'm doing this because values of 0 indicate data is missing which is required for previous arithmetic
...
Let's start replicating analysis I did in Excel before moving on to novel analyses
```{r : stats - total_standardised_daily_dose_per_BSA}
stats_Nov22_Nov23_dose_per_BSA <- Nov22_Nov23_minimal_dataset %>%
  summarise("mean daily dose per BSA" = mean(Nov22_Nov23_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "median daily dose per BSA" = median(Nov22_Nov23_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "SD daily dose per BSA" = sd(Nov22_Nov23_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "min daily dose per BSA" = min(Nov22_Nov23_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T),
            "max daily dose per BSA" = max(Nov22_Nov23_minimal_dataset$total_standardised_daily_dose_per_BSA, na.rm = T)) %>%
