...
DexamethasoneBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Dexamethasone",], "Total_raw_dose", "None", "total dose dexamethasone 22-25")
...
EfmodyBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Efmody",], "Total_raw_dose", "None", "total dose efmody 22-25")
...
HydrocortisoneBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Hydrocortisone",], "Total_raw_dose", "None", "total dose hydro 22-25")
...
PrednisoloneBoxPlot_23_25 <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Prednisolone",], "Total_raw_dose", "None", "total dose prednisolone 22-25")
```
...
equiv_DexamethasoneBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Dexamethasone",], "HC_equivalent_daily_dose_1_1", "None", "HC equivalent dose dexamethasone 22-25")
...
equiv_PrednisoloneBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Prednisolone",], "HC_equivalent_daily_dose_1_1", "None", "HC equivalent dose prednisolone 22-25")
```
...
HC_equiv_BSA_DexamethasoneBoxPlot_all <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Dexamethasone",], "HC_equivalent_daily_dose_per_BSA", "None", "HC equiv per BSA dose dexamethasone 22-25")
...
HC_equiv_BSA_EfmodyBoxPlot_23_25 <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Efmody",], "HC_equivalent_daily_dose_per_BSA", "None", "HC equiv per BSA dose efmody 22-25")
...
HC_equiv_BSA_HydrocortisoneBoxPlot_23_25 <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Hydrocortisone",], "HC_equivalent_daily_dose_per_BSA", "None", "HC per BSA dose hydro 22-25")


## Prednisolone
HC_equiv_BSA_PrednisoloneBoxPlot_22_23 <- MDBoxPlot(therapy_22_23_single[therapy_22_23_single$Medicine_1.x == "Prednisolone",], "HC_equivalent_daily_dose_per_BSA", "None", "HC equiv per BSA dose prednisolone 22-23")
...
HC_equiv_BSA_PrednisoloneBoxPlot_23_25 <- MDBoxPlot(all_therapy_22_25_single[all_therapy_22_25_single$Medicine_1.x == "Prednisolone",], "HC_equivalent_daily_dose_per_BSA", "None", "HC equiv per BSA dose prednisolone 22-25")
```
