...
stand_DexamethasoneBoxPlot_22_23 <- MDBoxPlot(therapy_22_23_single[therapy_22_23_single$Medicine_1.x == "Dexamethasone",], "total_standardised_daily_dose_1_1", "None", "total standardised dose dexamethasone 22-23")

stand_DexamethasoneBoxPlot_23_25 <- MDBoxPlot(therapy_23_25_single[therapy_23_25_single$Medicine_1.x == "Dexamethasone",], "total_standardised_daily_dose_1_1", "None", "total standardised dose dexamethasone 23-25")

stand_PrednisoloneBoxPlot_22_23 <- MDBoxPlot(therapy_22_23_single[therapy_22_23_single$Medicine_1.x == "Prednisolone",], "total_standardised_daily_dose_1_1", "None", "total standardised dose prednisolone 22-23")

stand_PrednisoloneBoxPlot_23_25 <- MDBoxPlot(therapy_23_25_single[therapy_23_25_single$Medicine_1.x == "Prednisolone",], "total_standardised_daily_dose_1_1", "None", "total standardised dose prednisolone 23-25")
```
...
```{r : standardised dose stats}
stan_pred_doses_22_23 <- summariseMed(therapy_22_23_single, "Prednisolone", "standardised")

stan_pred_doses_23_25 <- summariseMed(therapy_23_25_single, "Prednisolone", "standardised")

stan_dex_doses_22_23 <- summariseMed(therapy_22_23_single, "Dexamethasone", "standardised")

stan_dex_doses_23_25 <- summariseMed(therapy_23_25_single, "Dexamethasone", "standardised")
```

```{r}
therapy_22_23_single$Centre.ID.x <- as.factor(therapy_22_23_single$Centre.ID.x)

dose_trends_22_23 <- ggplot(therapy_22_23_single, aes(x = Centre.ID.x, y = total_standardised_daily_dose_1_1, fill = Medicine_1.x)) +
  geom_boxplot() +
  theme_minimal() +
...
dose_trends_23_25 <- ggplot(therapy_23_25_single, aes(x = Centre.ID.x, y = total_standardised_daily_dose_1_1, fill = Medicine_1.x)) +
  geom_boxplot() +
  theme_minimal() +
  geom_point(position = position_dodge(width = 0.75)) +
  ylim(0,80)
...
```{r}
HC_single_test <- therapy_23_25_single[therapy_23_25_single$Medicine_1.y == "Hydrocortisone",]
